...
function ProduitAddModal({ isOpen, onClose, onSuccess }) {
  ...
  const handleSubmit = (e) => {
    ...
    formData.append("emplacement_stock", emplacementStock);
    formData.append("poids", parseFloat(poids));
    formData.append("unite_mesure", uniteMesure);
    ...
    axios
      .post(`${URL}/api/produits`, formData, {
        headers: {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white w-full max-w-4xl rounded-lg p-6 relative">
        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-2 gap-4">
          ...
          <div className="flex items-center border p-2 rounded">
            <input
              placeholder="Emplacement en stock"
