...
function FournisseurEditModal({ isOpen, onClose, fournisseur, onSuccess }) {
    ...
    try {
      ...
      if (error.response && error.response.data && error.response.data.message) {
        ...
        if (msg.includes("champ nom")) {
          ...
          showAlert("Erreur lors de la modification du fournisseur.");
        }
      } else {
...
export default FournisseurEditModal;
